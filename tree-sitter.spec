...
Version  : 0.20.5
Release  : 2
URL      : https://github.com/tree-sitter/tree-sitter/archive/v0.20.5/tree-sitter-0.20.5.tar.gz
Source0  : https://github.com/tree-sitter/tree-sitter/archive/v0.20.5/tree-sitter-0.20.5.tar.gz
...
%prep
%setup -q -n tree-sitter-0.20.5
cd %{_builddir}/tree-sitter-0.20.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646281199
...
cp %{_builddir}/tree-sitter-0.20.5/LICENSE %{buildroot}/usr/share/package-licenses/tree-sitter/0d88b1fe204b8601d0cf7c9de8c2bc4d64a627a6
