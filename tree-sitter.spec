...
Version  : 0.20.7
Release  : 4
URL      : https://github.com/tree-sitter/tree-sitter/archive/v0.20.7/tree-sitter-0.20.7.tar.gz
Source0  : https://github.com/tree-sitter/tree-sitter/archive/v0.20.7/tree-sitter-0.20.7.tar.gz
...
%prep
%setup -q -n tree-sitter-0.20.7
cd %{_builddir}/tree-sitter-0.20.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662674632
