...
Source0  : https://github.com/tree-sitter/tree-sitter/archive/v0.24.7/tree-sitter-0.24.7.tar.gz
...
%prep
%setup -q -n tree-sitter-0.24.7
cd %{_builddir}
tar xf %{_sourcedir}/tree-sitter-2024-12-25-08-53-57.tar.gz
cd %{_builddir}/tree-sitter-0.24.7
mkdir -p ./vendor
cp -r %{_builddir}/tree-sitter-2024-12-25-08-53-57/* %{_builddir}/tree-sitter-0.24.7/./vendor
mkdir -p .cargo
...
' >> .cargo/config.toml
pushd ..
cp -a tree-sitter-0.24.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736782765
...
cp %{_builddir}/tree-sitter-2024-12-25-08-53-57/rand_core/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/tree-sitter/0ff30cb09f7056217d089f352fe089b49971eeae || :
